...
def _columns():
	return [
		...
		{"label": _("Vigilante"), "fieldname": "vigilante", "fieldtype": "Link", "options": "Vigilante", "width": 150},
		...
		{"label": _("Antigo Posto"), "fieldname": "antigo_posto", "fieldtype": "Link", "options": "Posto De Vigilancia", "width": 160},
		{"label": _("Cliente (Antigo)"), "fieldname": "cliente_antigo_posto", "fieldtype": "Data", "width": 130},
		{"label": _("Novo Posto"), "fieldname": "novo_posto", "fieldtype": "Link", "options": "Posto De Vigilancia", "width": 160},
		{"label": _("Cliente (Novo)"), "fieldname": "cliente_novo_posto", "fieldtype": "Data", "width": 130},
